...
<div class="modal fade" id="modalRegistrarConsejo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" novalidate id="formRegistrarConsejo" action="{{ route('consejos-comunales.store') }}" autocomplete="off" method="POST">
                    @csrf
                    <div class="row g-3">
                        <!-- Nombre del Consejo -->
                        <div class="col-12 col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="nombre" id="nombre" placeholder="Nombre del Consejo" required maxlength="255" value="{{ old('nombre') }}">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="rif" id="rif" placeholder="123456789" required maxlength="10" pattern="^C?\d{9}$" title="Ingrese 9 dígitos numéricos (Ej: 123456789) o C seguido de 9 dígitos (Ej: C123456789)" value="{{ old('rif') ? preg_replace('/^C/i','', old('rif')) : '' }}">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control bg-white" name="direccion" id="direccion" placeholder="Dirección" required maxlength="500" style="height: 100px;">{{ old('direccion') }}</textarea>
