...
<head>
    <meta charset="UTF-8">
    <title>Carta de Buena Conducta - {{ $persona->cedula }}</title>
    <style>
        @page {
            margin: 0px;
        }
...
<body>
    ...
    <div class="body-text">
        ...
        Es habitante de nuestra comunidad y durante el tiempo que tiene residiendo en nuestro ámbito geográfico ha demostrado mantener una excelente conducta 
        moral y cívica, siendo una persona de buenas costumbres, colaboradora, responsable y estrictamente respetuosa de las normas de convivencia ciudadana, 
        no teniendo nuestro Consejo Comunal queja alguna sobre su comportamiento.
    </div>
