        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-muted small">Ingrese la cédula de identidad del ciudadano registrado en el censo para
                            cargar sus datos.</p>
                        ...
                        <div class="alert alert-info d-flex align-items-center mb-0 mt-2" role="alert"
                            id="instruccion_alerta">
                            <i class="ri-information-line fs-4 me-2"></i>
                            <div>
                                El ciudadano debe estar registrado en el censo, tener dirección válida y pertenecer a un
                                Consejo Comunal con Jefe de Comando asignado.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card d-none" id="card_datos_ciudadano">
                    <div class="card-header bg-primary text-white py-3">
                        <h5 class="card-title mb-0 text-white"><i class="ri-user-shared-line me-2"></i>Datos del Ciudadano
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item d-flex flex-column bg-transparent px-0 pb-0">
                                <span class="text-muted mb-1"><i class="ri-map-pin-line me-2"></i>Dirección
                                    Registrada</span>
            ...
            <div class="col-lg-7">
                <div class="card d-none" id="card_generacion_actas">
                    <div class="card-header">
                        <h4 class="card-title"><i class="ri-file-edit-line text-primary me-2"></i>Configuración de Actas
                        </h4>
                    </div>
                    <div class="card-body p-3">
                        ...
                        <ul class="nav nav-tabs nav-fill" id="actasTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active py-3 font-weight-bold" id="residencia-tab"
                                    data-bs-toggle="tab" data-bs-target="#residencia" type="button" role="tab"
                                    aria-controls="residencia" aria-selected="true">
                                    <i class="ri-home-8-line me-2"></i>Constancia de Residencia
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link py-3 font-weight-bold" id="buena-conducta-tab" data-bs-toggle="tab"
                                    data-bs-target="#buena_conducta" type="button" role="tab"
                                    aria-controls="buena_conducta" aria-selected="false">
                        ...
                        <div class="tab-content p-4" id="actasTabContent">
                            ...
                            <div class="tab-pane fade show active" id="residencia" role="tabpanel"
                                aria-labelledby="residencia-tab">
                                <form action="{{ route('actas.residencia-pdf') }}" method="POST" target="_blank"
                                    id="form_residencia">
                                    @csrf
                                    ...
                                    <div class="alert alert-warning mb-4 d-flex align-items-center">
                                        ...
                                        <div>
                                            Este documento certifica el tiempo de residencia del ciudadano en el ámbito
                                            territorial del Consejo Comunal.
                                        </div>
                                    </div>

                                    <div class="form-group mb-4">
                                        <label class="form-label font-weight-bold" for="anios_residencia">Años de
                                            Domicilio <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="anios_residencia"
                                                id="anios_residencia" placeholder="Ingrese los años domiciliado"
                                                min="0" max="120" required>
                                            <span class="input-group-text bg-light">años</span>
                                        </div>
                                        <div class="form-text">Indique manualmente el número de años que el ciudadano tiene
                                            residiendo en la comunidad.</div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="buena_conducta" role="tabpanel"
                                aria-labelledby="buena-conducta-tab">
                                <form action="{{ route('actas.buena-conducta-pdf') }}" method="POST" target="_blank"
                                    id="form_buena_conducta">
                                    @csrf
                                    <input type="hidden" name="cedula" class="hidden_cedula">
                                    ...
                                    <div class="alert alert-warning mb-4 d-flex align-items-center">
                                        <i class="ri-alert-line fs-4 me-2"></i>
                                        <div>
                                            Este documento hace constar que el ciudadano es un habitante activo de la
                                            comunidad con excelente conducta moral, cívica y de convivencia.
                                        </div>
                                    </div>

                                    <p class="text-muted mb-4">No se requiere ingresar campos adicionales. La carta se
                                        generará usando los datos de filiación y el Consejo Comunal del censo actual.</p>
                ...
                <div class="card text-center py-5" id="card_placeholder">
                    <div class="card-body">
                        ...
                        <p class="text-muted px-4 mt-2">Busque y seleccione un ciudadano mediante su cédula a la izquierda
                            para poder previsualizar sus datos y configurar la emisión de actas y constancias.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.responseJSON && xhr.responseJSON.message) {
                            ...
                            message =
                                'El ciudadano con la cédula ingresada no se encuentra registrado en el censo.';
                        }
