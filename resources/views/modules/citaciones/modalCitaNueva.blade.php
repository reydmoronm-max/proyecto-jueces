    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="modalCitaNuevaLabel">MARCAR COMO INASISTENTE</h5>
                    ...
                    <section class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control bg-white" name="observaciones" id="observaciones" placeholder="¿Por qué no asistió?" required>
                            </div>
                        </div>
