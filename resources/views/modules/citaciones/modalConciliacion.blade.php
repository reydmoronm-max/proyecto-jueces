                ...
                <form class="needs-validation" novalidate id="formConciliacion"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-lg-5 border-end-lg">
                            <h6 class="text-primary mb-3 border-bottom pb-1">Datos del Requerido</h6>
                            <div class="row g-3">
                                <div class="col-12">
                                    <label for="cedula" class="form-label mb-1 fw-bold text-muted small">Cédula del
                                        requerido</label>
                                    <div class="input-group">
                                        <select id="cedula_tipo" name="cedula_tipo" class="form-select bg-white"
                                            style="max-width: 80px;" required>
                                            <option value="V"
                                                {{ old('cedula_tipo', 'V') == 'V' ? 'selected' : '' }}>V</option>
                                            <option value="E" {{ old('cedula_tipo') == 'E' ? 'selected' : '' }}>E
                                            </option>
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input id="telefono" type="number" name="telefono"
                                            class="form-control bg-white" placeholder="Teléfono"
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control bg-white" name="direccion" id="direccion" placeholder="Dirección" style="height: 85px;"
                                            required></textarea>
