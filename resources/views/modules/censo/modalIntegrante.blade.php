<div class="modal fade" id="modalRegistrarIntegrante" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body py-2">
                <form class="needs-validation" novalidate id="formIntegrante" action="{{ route('censo.integrante.store') }}" autocomplete="off" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating">
                                <input id="cedula" type="number" name="cedula" class="form-control bg-white" placeholder="Cédula" required
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="telefono" id="telefono" placeholder="Teléfono">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating" style="margin-top: 24px;">
                                <input type="number" class="form-control bg-white" name="cantidad_integrantes" id="cantidad_integrantes" placeholder="Cant. integrantes" required min="1">
                                <label for="cantidad_integrantes">Cantidad de integrantes núcleo</label>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="centro_votacion" id="centro_votacion" placeholder="Centro de Votación">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="carnet_patria" id="carnet_patria" placeholder="Carnet de la Patria">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating">
                                <select name="nivel_academico" id="nivel_academico" class="form-select bg-white" required>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="profesion" id="profesion" placeholder="Profesión">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="situacion_laboral" id="situacion_laboral" placeholder="Situación laboral">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="tipo_enfermedad" id="tipo_enfermedad" placeholder="Tipo de enfermedad">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white" name="ayuda_tecnica" id="ayuda_tecnica" placeholder="Ayuda técnica mencionada">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating">
                                <select name="bono_unico_familiar" id="bono_unico_familiar" class="form-select bg-white" required>
                                    <option value="" selected disabled>Seleccione...</option>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-floating">
                                <select name="pensionado_jubilado" id="pensionado_jubilado" class="form-select bg-white" required>
                                    <option value="" selected disabled>Seleccione...</option>
                                    <option value="Sí">Sí</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-floating">
                                <select name="mision_vivienda" id="mision_vivienda" class="form-select bg-white" required>
                                    <option value="" selected disabled>Seleccione...</option>
                                    <option value="Sí">Sí</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-floating">
                                <select name="casa_alimentacion" id="casa_alimentacion" class="form-select bg-white" required>
                                    <option value="" selected disabled>Seleccione...</option>
                                    <option value="Sí">Sí</option>
                                    <option value="No">No</option>
                                </select>
