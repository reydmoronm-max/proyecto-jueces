    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="ri-home-line me-1 text-primary"></i> <span id="lbl_numero_familia"></span></h5>
                    ...
                    <div class="card-body p-3">
                        <div class="row g-2 small">
                            <div class="col-12 col-md-6">
                                ...
                                <span id="view_fam_consejo_comunal" class="fw-semibold text-dark">No asignado</span>
                            </div>
