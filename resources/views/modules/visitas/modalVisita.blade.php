            ...
            <form id="formRegistrarVisita" method="POST" action="{{ route('visitas.store') }}">
                ...
                <div class="modal-body">
                    <section class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-floating">
                                <input id="telefono" type="text" name="telefono" class="form-control" placeholder="Teléfono" value="{{ old('telefono') }}" maxlength="11" minlength="11" inputmode="tel">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea id="direccion" name="direccion" class="form-control" placeholder="Dirección" rows="3">{{ old('direccion') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="proposito" name="proposito" class="form-control" rows="3" placeholder="Propósito" required>{{ old('proposito') }}</textarea>
                        </div>
